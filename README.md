...
| moonship.markets.*MARKET_NAME*.account_name               | The name of the account to use at the cryptocurrency exchange by default when placing orders in the *MARKET_NAME* market. This parameter is optional and can be overridden on a per-order basis. <br/><br/>                                                                                                                         |
