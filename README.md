...
- Supports paper trading for testing and validating strategies in a semi-live environment with real-time market data.
- Handles various cryptocurrency exchanges:
  - AltCoinTrader 
  - Binance
  - Luno
  - VALR
...
| moonship.markets.*MARKET_NAME*.candle_period          | The default period to use in seconds when retrieving candle (K-line) information for the *MARKET_NAME* market.<br/><br/>This parameter also defines the polling period to use to automatically retrieve the latest candle information for the market.<br/><br/>Supported values:<ul><li>0 (no default; automatic candle retrieval disabled)</li><li>60 (1m)</li><li>300 (5m)</li><li>900 (15m)</li><li>1800 (30m)</li><li>3600 (1h)</li><li>86400 (24h)</li></ul>Defaults to 300.                                                                                                                                                                                                                                                                                                  |
| moonship.markets.*MARKET_NAME*.client                 | The name of the Market Client implementation class that is used to communicate with the cryptocurrency exchange for the *MARKET_NAME* market.<br/><br/> Supported values:<ul><li>moonship.client.altcointrader.AltCoinTraderClient</li><li>moonship.client.binance.BinanceClient</li><li>moonship.client.luno.LunoClient</li><li>moonship.client.paper.PaperTradingClient</li><li>moonship.client.valr.ValrClient</li></ul> Use the value for the relevant cryptocurrency exchange.<br/><br/>The *PaperTradingClient* is a special wrapper implementation that intercepts and handles order requests offline, allowing strategies to be tested and validated in a semi-live environment before full deployment. See the `moonship.markets.MARKET_NAME.real_client` property below. |
| moonship.markets.*MARKET_NAME*.real_client   | The name of the Market Client implementation class that is wrapped by the *PaperTradingClient*. This client is used for all communication with the cryptocurrency exchange, except for the following requests: <ul><li>order placement, cancellation and retrieval;</li><li>asset/account balance retrieval.</li></ul>Order-related and asset balance requests are handled by the *PaperTradingClient* offline.<br/><br/> This property is only applicable when `moonship.markets.MARKET_NAME.client` is set to *moonship.client.paper.PaperTradingClient*.                                                                                                                                                                                                                        |
| moonship.markets.*MARKET_NAME*.max_recent_trade_list_size | The maximum number of the most recent trades to cache in memory for the *MARKET_NAME* market.<br/><br/>Defaults to 10000. Set to 0 to disable this cache.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| Property                       | Description                                                                                                          |
|--------------------------------|----------------------------------------------------------------------------------------------------------------------|
| moonship.altcointrader.api_key | The AltCoinTrader API key. Can also be specified per market if different AltCoinTrader markets require different API keys. |
| moonship.altcointrader.api_secret | The AltCoinTrader API secret. Can also be specified per market if different AltCoinTrader markets require different API secrets. |
...
| Property                       | Description                                                                                                                                                                                                                                                                                                                                                        |
|--------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| moonship.redis.protocol        | The Redis serialisation protocol (RESP) version.<br/><br/>Only set this if required.<br/><br/>Set to 2 for RESP2, 3 for RESP3, or leave unset to use the default protocol version for the Redis client.                                                                                                                                                         |
