...
| moonship.markets.*MARKET_NAME*.client                     | The name of the Market Client implementation class that is used to communicate with the cryptocurrency exchange for the *MARKET_NAME* market.<br/><br/> Supported values:<ul><li>moonship.client.altcointrader.AltCoinTraderClient</li><li>moonship.client.binance.BinanceClient</li><li>moonship.client.luno.LunoClient</li><li>moonship.client.valr.ValrClient</li></ul>                                                                                                        |
